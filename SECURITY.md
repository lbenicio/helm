...
The following versions of `helm` are currently supported with security updates:
...
- Preferred: Open a private report via GitHub Security Advisories — [Create a private advisory](https://github.com/lbenicio/helm/security/advisories/new)
- Alternative: If you prefer email, use the contact email published on the site. For encrypted mail, you can use the PGP key.
